...
function testMode() {
    ...
    console.clear();
    console.log("%cFINAPP", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #F9B81F; padding: 10px 120px; margin-bottom: 16px;")
    ...
    function testModeInfo(value, msg) {
        console.log("%c|" + "%c " + msg + " : " + "%c" + value, "color: #444; font-size :1.2em; font-weight: bold;", "color: inherit", "color:#F9B81F; font-weight: bold;");
    }
